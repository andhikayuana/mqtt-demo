...
public class PahoMqqtClient {

    private static final String TAG = "PahoMqttClient";
    private static PahoMqqtClient pahoMqqtClient;
    private MqttAndroidClient mqttAndroidClient;

    public static PahoMqqtClient getInstance() {
        if (pahoMqqtClient == null) pahoMqqtClient = new PahoMqqtClient();
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    Log.d(TAG, "connect : Failure " + exception.toString());
                }
            });
